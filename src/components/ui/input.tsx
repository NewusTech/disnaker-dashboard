        ...
        return (
            <div className="relative w-full flex items-center">
                ...
                <input
                    ...
                    className={cn(
                        "flex h-11 w-full font-normal rounded-full border-[2px] border-[#E4E4E7] bg-white px-4 py-5 text-md ring-offset-white file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-[#AAAAB4] placeholder:font-normal focus-visible:outline-none focus-visible:ring-none focus-visible:border-primary disabled:cursor-not-allowed disabled:opacity-50 text-sm",
