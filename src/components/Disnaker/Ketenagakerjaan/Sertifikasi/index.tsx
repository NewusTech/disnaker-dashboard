                ...
                <TableBody>
                    {data.map((user) => (
                        <TableRow key={user.no}>
                            ...
                            <TableCell className="text-center" >{user.judulSertifikasi}</TableCell>
                                        ...
                                        <DropdownMenuContent className="w-fit mr-8 mt-1 bg-white">
                                            ...
                                            <DropdownMenuGroup>
                                                <DropdownMenuItem onSelect={(e) => e.preventDefault()}>
                                                    <Link className="w-full" href={`/layanan-ketenagakerjaan/sertifikasi/detail`}>
                                                ...
                                                <DropdownMenuItem onSelect={(e) => e.preventDefault()}>
                                                    <Link className="w-full" href={`/layanan-ketenagakerjaan/sertifikasi/edit`}>
                                                        <div className="flex items-center gap-2 text-gray-600 hover:text-gray-800">
                                                            Edit
                                                        </div>
                                                    </Link>
