...
const DetailLamaran = () => {
    const breadcrumbItems = [
        ...
        { label: 'Akun Pengguna', href: "/data-pengguna/akun-pengguna" },  // No logo 
        { label: 'Undang Pengguna' },  // No logo 
    ];

    // Example handler for inviting users
    const handleInvite = async (selectedJobs: string[]) => {
        // Simulate an API call
        console.log('Invited for jobs:', selectedJobs);
    };
    ...
    return (
        <div>
            ...
            <div className="wrap flex flex-col gap-5">
                ...
                <div className="garis h-[1px] w-full bg-[#C7C7CD] my-2"></div>
                <InvitePopup onInvite={handleInvite} />
                <div className="garis h-[1px] w-full bg-[#C7C7CD] my-2"></div>
                {/* button */}
