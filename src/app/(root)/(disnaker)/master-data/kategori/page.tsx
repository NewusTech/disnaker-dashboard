...
const Kategori = () => {
    ...
    // Handle form submission for adding a new kategori
    const onSubmit: SubmitHandler<FormData> = async (formData) => {
        setLoading(true);
        try {
            // Simulate API call to add kategori
            console.log("Kategori added:", formData);
                    ...
                    >
                        ...
                        <div className="heda mb-5 flex flex-col gap-1 justify-center items-center">
                            <div className="text-lg font-medium">
                                Tambah Master Data Kategori Pekerjaan
                            </div>
                            <div className="">
