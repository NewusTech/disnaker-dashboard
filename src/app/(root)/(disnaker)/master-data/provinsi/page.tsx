...
import DataTable from '@/components/Disnaker/MasterData/Provinsi';
...
const Provinsi = () => {
    ...
    // Handle form submission for adding a new provinsi
    const onSubmit: SubmitHandler<FormData> = async (formData) => {
        setLoading(true);
        try {
            // Simulate API call to add provinsi
            console.log("Provinsi added:", formData);
