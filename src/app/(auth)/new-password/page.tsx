                    ...
                    <div className="right px-4 md:mx-0 w-full h-full bg-primary md:bg-slate-50 flex flex-col justify-center items-center">
                        ...
                        <div className="card w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-2xl mx-3 xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                            <div className="p-6 sm:p-8">
                                ...
                                <h2 className="text-center font-medium text-xl md:text-2xl md:mb-10 md:mt-6 mb-5 mt-3">Buat Password Baru!</h2>
                                <form
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        {errors.confirmPassword && (
                                            <HelperError>{errors.confirmPassword.message}</HelperError>
                                        )}
                                    </div>
                                    {loginError && (
